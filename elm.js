...
var $author$project$Page$Login$initialModel = {data: _List_Nil};
...
var $author$project$Page$Login$footer = A2(
	$elm$html$Html$div,
	_List_fromArray(
		[
			$elm$html$Html$Attributes$class('footer container-lg p-responsive py-6 mt-6 f6')
		]),
	_List_fromArray(
		[
			A2(
			...
			_List_fromArray(
				[
					$elm$html$Html$Attributes$class('list-style-none d-flex flex-justify-center')
				]),
			_List_fromArray(
				[
					A2(
					...
					_List_fromArray(
						[
							...
							_List_fromArray(
								[
									$elm$html$Html$Attributes$href('/site/terms')
								]),
							_List_fromArray(
								[
					...
					_List_fromArray(
						[
							...
							_List_fromArray(
								[
									$elm$html$Html$Attributes$href('/site/privacy')
								]),
							_List_fromArray(
								[
					...
					_List_fromArray(
						[
							...
							_List_fromArray(
								[
									$elm$html$Html$Attributes$href('https://help.github.com/articles/github-security/')
								]),
							_List_fromArray(
								[
					...
					_List_fromArray(
						[
							...
							_List_fromArray(
								[
									$elm$html$Html$Attributes$class('link-gray'),
									$elm$html$Html$Attributes$href('https://github.com/contact')
								]),
							_List_fromArray(
								[
									$elm$html$Html$text('Contact GitHub')
								]))
						]))
				]))
		]));
